    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          icon: Download,
          label: "Download APK",
          url: "https://github.com/vardhan781/Rare-Fashion-Application/releases/download/v1.0/RareFashion-v1.0.apk",
        },
        {
          type: "docs",
          icon: FileText,
          label: "App Details",
          url: "https://github.com/vardhan781/Rare-Fashion-Application/blob/main/App.md",
        },
      ],
      type: "mobile",
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          icon: Download,
          label: "Download APK",
          url: "https://github.com/vardhan781/Sphere/releases/download/v1.0/Sphere-v1.0.apk",
        },
        {
          type: "docs",
          icon: FileText,
          label: "App Details",
          url: "https://github.com/vardhan781/Sphere/blob/master/App.md",
        },
      ],
      type: "mobile",
    },
